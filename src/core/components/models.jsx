...
import { Card, H2, H3 } from "@tencent/tea-component";
...
export default class Models extends Component {
  ...
  render(){
    ...
    return (
      <div ref={this.onLoadModels} style={{padding: "0 20px"}}>
        <H2 style={{marginBottom: "20px"}}>{isOAS3 ? "Schemas" : "Models"}</H2>
        <div>
          {
            definitions.entrySeq().map(([name])=>{
              ...
              return (
                ...
                >
                  <H3 style={{marginBottom: "12px"}}>{displayName}</H3>
                  {content}
                </div>
              )
            }).toArray()
